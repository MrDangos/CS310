/*
   ...
   Corrections by: Hugo 
   Fix 1: Changed Java-style inline access specifiers to valid C++ access specifier blocks
   Fix 2: Replaced invalid string + int concatenation with std::to_string() calls in both Shape::GetDimensions() and Circle::GetDimensions().
*/
